...
def registration_request(request):
    context = {}
    #if it is a get request then just render the html page to registration
    if request.method == "GET":
        return render(request, 'onlinecourse/user_registration.html', context)
    #if it is a post request then get the username and password from the request.POST dictionary
